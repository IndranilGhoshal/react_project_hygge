...
function Congratulations_mind_m(props) {
    ...
    return (<>
        <div class={isLoad ? "wrapper mymindcong mobile_cong_top" : "wrapper mymindcong mymindcongbg mobile_cong_top"} >
...
export default Congratulations_mind_m;