...
function Congrtulation_life_m(props) {
    ...
    return (<>
        <div class={isLoad ? "wrapper mylifestylecong mobile_cong_top" : "wrapper mylifestylecong mylifestylecongbg mobile_cong_top"} >
...
export default Congrtulation_life_m;