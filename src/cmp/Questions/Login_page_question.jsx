...
function Login_Page_Question(props) {
    ...
    useEffect(() => {
        ...
        if (deviceDetails().device_type == 'mobile') {
            handleShow()
    ...
    const [orgn_id, setOrg_id] = useState('')
        ...
        if (err == 0) {
            ...
            sendMailOtp(data, token).then(result => {
                ...
                if (result.data.success) {
                    ...
                    setOrg_id(result.data.response.orgn_id)
                    setEmp_id(result.data.response.emp_id)
                    setDelay("120")
                    setMinutes('02');
                    setSeconds('00');
                } else {
    ...
    return (
        <>
            <div className="wrapper ">
                <div className="main_div hra_pgese">
                    ...
                    <div className="logn_dv_in">
                                    ...
                                    <form method="get" id="form1" className="digit-group" data-group-name="digits" data-autosubmit="false" autoComplete="off">
                                        ...
                                        <div class="input-container ic2">
                                            <div class="incorr_otp">
                                                {otpError ? <p><span class="incorr-pass">{otpError}</span></p> : <p></p>}
                                            </div>
                                        </div>
                        ...
                        <div class="btm_sc">
                            <p>By Logging in you agree to our<br /> <TermsAndConditions /> and <PrivacyPolicy data={policyData} /></p>
                        </div>
                    </div>
                </div>
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>In case you don't open that link on the Gmail browser. Please go to Gmail Settings -{'>'} General Settings -{'>'} Uncheck Open web links in Gmail.</Modal.Body>
