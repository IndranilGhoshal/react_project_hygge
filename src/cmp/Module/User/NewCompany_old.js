...
import { addCompanySuper, checkUser, uploadLogo, getCountry, getCity, getLicenseKey, userEvent } from '../../../service/Services';
import $ from 'jquery'
...
function NewCompany() {
    ...
    const [startDate, setStartDate] = React.useState("2022-11-01")
    const [endDate, setEndDate] = React.useState("2023-11-01")
    ...
    const continuefun1 = () => {
        ...
        for (let [i, data] of userContactArray.entries()) {
            ...
            if (data.contact_number) {
                ...
                if (!z1.test(data.contact_number)) {
                    $("#conNo" + i).addClass('error-fil')
    ...
    const finalContinueFun = () => {
        ...
        if (err === 0) {
            ...
            var data = {
                ...
                "parent_organisation_name": parentcompanyName,
                ...
                "organisation_address": comAddress,
                ...
                "smtp_setting": {
                    "smtp_server_address": serverAddress,
                    "username": username,
                    "password": password,
                                                    ...
                                                    <div key={index}>
                                                        {
                                                            item.is_primary == 1 ?
                                                                ...
                                                                <div id="mor_contc" className="other_detl" >
                                                                    ...
                                                                    <button className="btn btn-nobg btn-lg remov_con" onClick={morcontcclose}><i
