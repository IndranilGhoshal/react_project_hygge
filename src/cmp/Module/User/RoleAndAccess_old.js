...
function RoleAndAccess() {
    ...
    const onCheckboxView = (e, index) => {
        ...
        var tempobj = {}
        var modulesArr = setModuleRoleArr
        ...
        <>
                                                ...
                                                <div className="bg-white shadow_d rounded-3">
                                                    ...
                                                    <div className="acces_tabl">
                                                        <div
                                                            ...
                                                            <div className="acc_hed" >Roles</div>
                                                            <div className="acc_hed" style={{marginLeft: "44px"}}>Status</div>
                                                                        ...
                                                                        {roleList.map((item, index) => (
                                                                            <div key={index}>
                                                                                <div className={`acc_list_out`} id={'access' + index}>
                                                                                    <div className="acc_list" style={{width:"140px"}}>{item.role_desc}</div>
                                                                                ...
                                                                                <div className="ass_edit_dv collapse" id={'collapsemanu' + index}>
                                                                                    ...
                                                                                    <div className="btn_edit">
                                                                                        ...
                                                                                        <button disabled={!canEditUser} className="btn btn-primary" onClick={() => { onSaveFun(item.role_id, index) }}>Save</button>
                                                    ...
                                                    <div className="col-md-5">
                                                        <div className="bg-white shadow_d rounded-3 my-5 me-3 ms-0 acces_rit">
                                                            ...
                                                            <div className="acces_tabl">
                                                                <div
                                                                    className="acces_tabl_top d-flex justify-content-between align-items-center">
                                                                    <div className="acc_hed" style={{width:"140px"}}>Modules</div>
                                                                ...
                                                                <div className="acces_tabl_blo mCustomScrollbar smootScrol">
                                                                    {
                                                                        moduleRoleArr.map((item, index) => (
                                                                            <div key={index} className="acc_list_out">
                                                                                <div className="acc_list" style={{width:"120px"}}>{item.menulabel}</div>
                    ...
                    <div className="modal-body accrol_mod">
                        ...
                        <div className="frm">
                            ...
                            <div className="add_btn">
                                <button type="button" className="btn btn-primary w-100 mt-5 ms-0" onClick={onAddRole} >Add</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="addrole">
                    ...
                    <div className="modal-body accrol_mod">
                        ...
                        <div className="frm">
                            ...
                            <div className="add_btn">
                                <button type="button" className="btn btn-primary w-100 mt-4 ms-0" onClick={onAddUser}>Add</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <Modal show={roleShow} onHide={handleRoleClose}>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" onClick={onRoleDelete}>
                        Yes
                    </Button>
                </Modal.Footer>
            </Modal>
            ...
            <Modal show={roleAdminShow} onHide={handleRoleAdminClose}>
                ...
                <Modal.Footer>
                    <Button variant="secondary" onClick={handleRoleAdminClose}>
                        No
                    </Button>
                    <Button variant="primary" onClick={onAdminRoleDelete}>
                        Yes
                    </Button>
                </Modal.Footer>
            </Modal>
