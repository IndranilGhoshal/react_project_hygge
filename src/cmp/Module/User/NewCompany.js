...
import { addCompanySuper, checkUser, uploadLogo, checkSmtp, getCountry, getCity, getLicenseKey, userEvent, smtpsetting } from '../../../service/Services';
import $ from 'jquery'
import { getIndustryType } from '../../../service/Services';
...
const contractFileType = ["image/png", "image/jpg", "image/jpeg", "image/gif", "application/pdf", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "application/msword", "application/pdf", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "text/csv"];
//--------------Import Images-----------//
const imageicon = require('../../../assets/images/image-icon.png');
//--------------Import Image Url--------------//
var imgUrl = IMAGE_URL
//Stateless Functional Component named NewCompany//
function NewCompany() {
    /* Variables */
    ...
    const [typeOfAccess, setTypeOfAccess] = React.useState("0")
    ...
    const [licenseLeft, setLicenseLeft] = React.useState("")
    const [tabChange, setTabChange] = React.useState({
        showTab: false,
    })
    const [contabChange, setConTabChange] = React.useState({
        showTab: false,
    })
    const [acLitabChange, setAcLiTabChange] = React.useState({
        showTab: false,
    })
    //breadcrumbs//
    ...
    const handleChange = (file) => {
        ...
        console.log(includesTwenty, file.type)
        if (!includesTwenty) {
        ...
        reader.onload = () => {
            ...
            uploadLogo(fileName).then(result => {
                ...
                if (result.success) {
                    ...
                    tempArr.push({ "file_name": filename, "original_file_name": file.name })
    ...
    const [licenseLeftErr, setLicenseLeftErr] = useState(false)
    const continuefun2 = () => {
        ...
        if (typeOfAccess && licenseLeft < noOfLicenses.trim()) {
            setLicenseLeftErr(true)
            err++
        }
        if (startDate === '') {
    ...
    const finalContinueFun = () => {
        ...
        if (err === 0) {
            var data = {
                ...
                "organisation_country": COUNTRY_LIST[country],
                ...
                "created_by": getUserData().response.organisation_name,
                "user_id": getUserData().response.userId

            }
            showLoader()
            addCompanySuper(data).then(result => {
                hideLoader()
                if (result.data.success) {
    ...
    function getLicenseKeyFun() {
        let licenseData = {
            "parent_orgn_id": getUserData().response.parent_orgn_id + "",
            "orgn_id": getUserData().response.orgn_id + ""
        }
        getLicenseKey(licenseData).then(result => {
            setLicenseKey(result.data.response[0].license_key)
            setLicenseLeft(result.data.response[0].license_left)
            setStartDate(moment(result.data.response[0].license_start_datetime).format('yyyy-MM-DD'))
            setEndDate(moment(result.data.response[0].license_end_datetime).format('yyyy-MM-DD'))
        })
    }
    const callCity = (e) => {
        setCityArray([])
                        ...
                        <div className="row mb-2 mb-lg-4">
                            <div className="col-md-12 main-hdng">
                                <div className="hesd_ng">
                                    <h3 className="compny-add">Add New Company</h3>
                                </div>
                                    ...
                                    <div className="tab-content" id="myTabContent">
                                            ...
                                            <div className="add_comp_fm">
                                                <div className={`add_fild_com ${comNameError ? "error-fil" : ""}`}>
                                                    ...
                                                    <input
                                                        ...
                                                        value={companyName}
                                                        onChange={(e) => { setCompanyName(e.target.value); onComNameChange(e.target.value); }}
                                                        required
                                                        onKeyDown={(e) => {
                                                ...
                                                <div className={`add_fild_com ${parcomNameError ? "error-fil" : ""}`}>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => { setParentCompanyName(e.target.value); onComParNameChange(e.target.value) }}
                                                        required
                                                        onKeyDown={(e) => {
                                                            if (!regspecial.test(e.key)) {
                                                                e.preventDefault();
                                            ...
                                            <div className="add_comp_fm">
                                                ...
                                                <div className={`add_fild_com ${noOfEmpError ? "error-fil" : ""}`}>
                                                    ...
                                                    <input
                                                        ...
                                                        value={noOfEmployee}
                                                        onChange={(e) => { setNoOfEmployee(e.target.value); onNoOfEmpChange(e.target.value) }}
                                                        required
                                                        onKeyDown={(e) => {
                                            ...
                                            <div className="add_comp_fm sing">
                                                ...
                                                <div className={`add_fild_com ${comAddressError ? "error-fil" : ""}`}>
                                                    ...
                                                    <input
                                                        ...
                                                        value={comAddress}
                                                        onChange={(e) => { setComAddress(e.target.value); onComAddChange(e.target.value) }}
                                                        required
                                                    />
                                                    {
                                                        comAddressError ?
                                            ...
                                            <div className="add_comp_fm">
                                                ...
                                                <div className={`add_fild_com ${conCityError ? "error-fil" : ""}`}>
                                                    ...
                                                    <div className="contct_no">
                                                        ...
                                                        <ReactFlagsSelect
                                                            ...
                                                            selected={country}
                                                            value={country}
                                                            onSelect={(e) => { setCountry(e); callCity(e) }}
                                                        />
                                                    ...
                                                    {
                                                        conCityError ? <span className='errorfiled'>Select the city</span> : null
                                                    }
                                                </div>
                                                ...
                                                <div className={`add_fild_com ${locError ? "error-fil" : ""}`}>
                                                    ...
                                                    <input
                                                        ...
                                                        value={location}
                                                        onChange={(e) => { setLocation(e.target.value); onComLocChange(e.target.value) }}
                                                        required
                                                        onKeyDown={(e) => {
                                                            if (!regspecial.test(e.key)) {
                                                                e.preventDefault();
                                        ...
                                        <div className="tab-pane fade " id="cont_dett" role="tabpanel"
                                                    ...
                                                    <div key={index}>
                                                        {
                                                            item.is_primary == 1 ?
                                                                ...
                                                                <div id="mor_contc" className="other_detl" >
                                                                    ...
                                                                    <button className="btn btn-nobg btn-lg remov_con" onClick={() => { morcontcclose(index) }}><i
                                                                        className="bi bi-plus-circle"></i> Delete Contact</button>
                                            ...
                                            <div className="mor_contct">
                                                ...
                                                <button className="btn btn-nobg btn-lg addnewcn" onClick={morcontc}><i
                                                    className="bi bi-plus-circle"></i> Add another contact</button>
                                        ...
                                        <div className="tab-pane fade " id="acc_lict" role="tabpanel"
                                            ...
                                            <div className="add_comp_fm">
                                                ...
                                                <div className={`add_fild_com ${typeOfAccessError ? "error-fil" : ""}`}>
                                                    ...
                                                    <select
                                                        className="form-select"
                                                        value={typeOfAccess}
                                                        onChange={(e) => { setTypeOfAccess(e.target.value); onTypeOfAccessChange(e.target.value) }}
                                                        required
                                                    >
                                                ...
                                                <div className={`add_fild_com ${noOfLicensesError || licenseLeftErr ? "error-fil" : ""}`}>
                                                    ...
                                                    {
                                                        licenseLeftErr ? <span className='errorfiled'>Sufficient license not available</span>
                                                            : null
                                                    }
                                                </div>
                                            ...
                                            <div className="add_comp_fm">
                                                ...
                                                <div className={`add_fild_com ${startDateError ? "error-fil" : ""}`}>
                                                    ...
                                                    {
                                                        startDateError ?
                                                            <span className='errorfiled'>Select the start date</span> : null
                                                    }
                                                </div>
                                                ...
                                                <div className={`add_fild_com ${endDateError ? "error-fil" : ""}`}>
                                                    ...
                                                    {
                                                        endDateError ?
                                                            <span className='errorfiled'>Select the end date</span> : null
                                                    }
                                                </div>
                                            ...
                                            {/* <div className="genert_lic_key">
                                                <label className='allign-middle mt-3' style={{ color: "#428FEC" }}>License Key</label>
                                                {
                                                    licenseKey ? <span>{licenseKey}</span> : null
                                                } 
                                            </div> */}
                                            ...
                                            <div className="add_comp_fm">
                                                <div className={`add_fild_com `}>
                                                    ...
                                                    <div className="contct_no">
                                                        ...
                                                        <div className={`contact_num ${portNumberError ? "error-fil" : ""}`}>
                                                            <input
                                                                type="number"
                                                                className="form-control"
