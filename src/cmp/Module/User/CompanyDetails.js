...
import { getUserRole, getUserData, showLoader, hideLoader, GetDecrypt } from '../../../service/Common';
import { getCompanyInfo, getIndustryType, getCity, getCountry, editProfileDetails, editSMTPDetails, editLicense, editContactDetails, userEvent, uploadLogo, getLicenseKey, checkSmtp, exportLicence } from '../../../service/Services'
...
function CompanyDetails() {
    ...
    const [checkLice, setCheckLice] = useState(false)

    const [noOfLicensesOth, setNoOfLicensesOth] = useState('')

    const [licenseLeft, setLicenseLeft] = React.useState("")

    const [licenseLeftErr, setLicenseLeftErr] = useState(false)

    var licVal = Number(licenseLeft) + Number(noOfLicenses)
    ...
    function getCompanyInfoFun() {
        ...
        getCompanyInfo(data).then(result => {
            ...
            setNoOfLicensesOth(result.data.response.number_of_license)
            ...
            setContractArr(result.data.response.contract)
    ...
    const onSave3 = () => {
        ...
        if (userLevel == 2) {
            ...
            if (noOfLicensesOth < noOfLicenses) {
                setCheckLice(true)
                err++
            }

            if (noOfLicensesOth && licVal < noOfLicensesOth) {
        ...
        if (err == 0) {
            ...
            var data = {
                "number_of_license": noOfLicensesOth,
                "license_start_datetime": startDate,
                "license_end_datetime": endDate,
                "orgn_id": id,
                "contract": contractArr,
                "parent_orgn_id": getUserData().response.parent_orgn_id,
                "organisation_flag": companyData.organisation_flag
            }
    ...
    const stack1 = (
        <>
            <div className={`add_drg conp_prof_edts set_edit ${contractFileError || contractResError ? "error-fil" : ""}  `}>
    ...
    const exportCom = () =>{
        ...
        var data = {
            "orgnId":companyData.orgn_id,
            "licencekey":companyData.license_key
        }

        showLoader()
        exportLicence(data).then(result => {
            if (result.data.success) {
                saveAs(IMAGE_URL + result.data.response, result.data.response)
                            ...
                            <div className="col-md-12 col-sm-12">
                                <div className="bg-white shadow_d pt-4 pb-5 px-5 rounded-3 dashboard_body_box">
                                    <div className="conpnay_detail_top d-flex justify-content-lg-start align-items-center mb-3">
                                        ...
                                        {
                                            userLevel == 1 ?
                                                <button className='btn btn-primary mx-2'onClick={()=>{exportCom()}} >Export</button> : null
                                        }
                                                ...
                                                <div className="conpnay_detail_in">
                                                    ...
                                                    <div className="two_div_con d-flex">
                                                        <div className="comp_list">
                                                            ...
                                                            <strong className='com-email'><a className='a-tag'>{companyData.organisation_email}</a></strong>
                                                        </div>
                                                        <div className="comp_list">
                                                            <span>Contact Number :</span>
                                                                            ...
                                                                            item.is_primary == 1 ?
                                                                                <div key={index} className="conpnay_detail_l">
                                                                                    ...
                                                                                    <div className="comp_list">
                                                                                        ...
                                                                                        <div className={`add_fild_com edit-comp-desig`} id={"dName" + index}>
                                                                                            <Autocomplete
                                                                                                name="designation"
                                                                    ...
                                                                    contactDetails.map((item, index) => (
                                                                        item.is_primary == 1 ?
                                                                            ...
                                                                            <div key={index} className="conpnay_detail_l">
                                                                                ...
                                                                                <div className="comp_list">
                                                                                    <span>Email ID :</span>
                                                                                    <strong className='com-email'><a href="">{item.email_id}</a></strong>
                                                                                </div>
                                                                                <div className="comp_list">
                                                                                    <span>Contact Number :</span>
                                            ...
                                            accessEdit ?
                                                <div className="conpnay_detail_in comp_edit">
                                                    ...
                                                    <div className="comp_list">
                                                        ...
                                                        <div className={`add_fild_com ${noOfLicensesError || checkLice || licenseLeftErr ? "error-fil" : ""}`}>
                                                            <input
                                                                type="number"
                                                                className="form-control"
                                                                placeholder=""
                                                                // min={noOfLicenses}
                                                                value={noOfLicensesOth}
                                                                onChange={(e) => { setNoOfLicensesOth(e.target.value); checkLic(e.target.value) }}
                                                                required
                                                                onKeyDown={(e) => {
                                                            ...
                                                            {
                                                                checkLice ?
                                                                    <span className='errorfiled'>License should be greater then previous license value</span>
                                                                    : null
                                                            }
                                                            {
