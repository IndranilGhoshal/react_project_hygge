...
import { getHraScore, getPhysicianReport, sendMailToUser, userEventQuestion } from "../../../service/questionService";
...
function Congratulations(props) {
    ...
    function getClassView() {
        ...
        if (isMobile) {
            if (isMailShow) {
                str = "wrapper congratpge congrat_bg cong_moble";
            } else {
                str = "wrapper congratpge hracongrat_bg cong_moble";
            }
        } else {
            if (isMailShow) {
                str = "wrapper congratpge congrat_bg";
            } else {
                str = "wrapper congratpge hracongrat_bg";
            }
        }
        return str;
    }
                            ...
                            <div class="cong_div_sec">
                                ...
                                {isHealthcare ?
                                    ...
                                    : <>
                                        <div class="chart_cong_btn">
                                            <img src={IMAGE_NAME.CONG_TIC} />
                                            <p>Your detailed HRA report has been successfully shared<br /> with you on</p>
                                            <a href={"mailto:" + email}>{email}</a>
                                        </div>
                                    </>
                                }
