...
import Congratulations_body from './My_Body/Congratulations_body';
import Congrtulation_life from './My_Lifestyle/Congrtulation_life';
import Congratulations_mind from './My_Mind/Congratulations_mind';
import { deviceDetails } from '../../device/Device';
import Informative_screen_one from './Informative/Informative_screen_one';
import Informative_screen_two from './Informative/Informative_screen_two';
import Info_pages from './Start_Up_Pages/Info_page';
...
function Question() {
    ...
    return (
        <>
            ...
            <div className="wrapper hraquestionSection" hidden={!isShow}>
                <nav id="" className={getSidebarClass(currPart)}>
                    <div className="sidebar-content" id="sidebar-sticky">
                        <div className="has-mnu">
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    <button
                                        className={currPart === 0 ? "nav-link active" : "nav-link"}
                                        id="mybody-tab"
                                        type="button"
                                        onClick={() => clickTab(0)}
                                    >
                                ...
                                <li className="nav-item" role="presentation">
                                    <button
                                        className={currPart === 1 ? "nav-link active" : "nav-link"}
                                        id="mylifestyle-tab"
                                        type="button"
                                        onClick={() => clickTab(1)}
                                    >
                                ...
                                <li className="nav-item" role="presentation">
                                    <button
                                        className={currPart === 2 ? "nav-link active" : "nav-link"}
                                        id="mymind-tab"
                                        type="button"
                                        onClick={() => clickTab(2)}
                                    >
                        ...
                        <img src={IMAGE_URL_ASSETS + currentQusetionData.side_img} />
                    ...
                    <main className="content">
                        <div className="container-fluid p-0">
                            ...
                            <div className="qstn_sc_rit">
                                <div className="qstn_headng">
                                    <div className="qstn_headng_in">
                                        <div className="clk_headng">
                                            ...
                                            <strong>{currentQusetionData.subcategorydesc}</strong>
                                ...
                                <div id="selectage" className="qstn_sec">
                                    <div className="qstn_sec_hed">
                                        ...
                                        <span>
                                            {currentQusetionData.qs_icon !== null ? <img src={IMAGE_URL_ASSETS + currentQusetionData.qs_icon} /> : (currentQusetionData.questionsequence > 9 ? currentQusetionData.questionsequence : "0" + currentQusetionData.questionsequence)}
                                        </span>
                                        {currentQusetionData.questiondesc}
                                    ...
                                    <div className="qstn_btn butn_dv">
                                        {currPart === 0 && currPosition === 0 ? <><button>&nbsp;</button></> :
                                            <button onClick={() => goBack()}><i className="bi bi-chevron-left"></i> back</button>
                                        }
            ...
            {bodyCg ? <Congratulations_body onContinueclick={() => continue_bg()} /> : <></>}

            {lifeCg ? <Congrtulation_life onContinueclick={() => continue_life()} /> : <></>}

            {mindCg ? <Congratulations_mind onContinueclick={() => continue_Mind()} /> : <></>}
        </>
    )
}
